...
source("rcode/later/smacofAccelerate.R")
source("rcode/later/smacofCompare.R")
source("rcode/later/smacofDerivatives.R")
source("rcode/later/smacofPCADerivative.R")
source("rcode/later/smacofQRDerivative.R")
source("rcode/later/smacofUtils.R")
