...
source("later/smacofAccelerate.R")
source("later/smacofCompare.R")
source("later/smacofDerivatives.R")
source("later/PCADerivative.R")
source("later/QRDerivative.R")
source("later/smacofUtils.R")
